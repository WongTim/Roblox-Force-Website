...
A fan page written in Python Flask and HTML illustrating a fictional group, Roblox Force. The website comes with multiple interactive activities to engage the user and can even track their progress through the back-end server. This README.md file will demonstrate how to use this website.
